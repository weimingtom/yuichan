...
public class TextBox extends Widget implements MouseListener, KeyListener {
	...
	public void keyPressed(KeyEvent keyEvent) throws GuichanException {
        ...
        if (key.getValue() == Key.LEFT) {
        	...
        	int len = mTextRows.get(mCaretRow).length() - mCaretColumn;
        	mTextRows.add(mCaretRow + 1, mTextRows.get(mCaretRow).substring(mCaretColumn, mCaretColumn + len));
	...
	public void draw(Graphics graphics) throws GuichanException {
        ...
        if (isFocused() && isEditable()) {
            drawCaret(graphics, getFont().getWidth(mTextRows.get(mCaretRow).substring(0, 0 + mCaretColumn)), mCaretRow * getFont().getHeight());
        }
    ...
    public void scrollToCaret() throws GuichanException {
        ...
        scroll.x = getFont().getWidth(mTextRows.get(mCaretRow).substring(0, 0 + mCaretColumn));
