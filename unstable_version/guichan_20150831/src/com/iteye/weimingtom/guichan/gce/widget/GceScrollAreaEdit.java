...
public class GceScrollAreaEdit extends ScrollArea {
	public GceScrollAreaEdit() {
		super();
	}

	public GceScrollAreaEdit(Widget content) throws GuichanException {
		super(content);
	}

	public GceScrollAreaEdit(Widget content, ScrollPolicy hPolicy,
