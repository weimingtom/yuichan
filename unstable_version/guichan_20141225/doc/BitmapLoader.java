 ...
 * @see http://worldwind31.arc.nasa.gov/svn/tags/1.5.1/WorldWind/src/performance/VBORenderer/BitmapLoader.java
 */
public class BitmapLoader
{
    ...
    private static BufferedImage read8BitBitmap(int nColoursUsed, int nBitCount, int nSizeImage, int nWidth,
        int nHeight, InputStream input) throws IOException
    {
