...
public class GceListBoxEdit extends ListBox {
	public GceListBoxEdit() throws GuichanException {
		super();
	}
	
	public GceListBoxEdit(ListModel listModel) throws GuichanException {
		super(listModel);
	}
