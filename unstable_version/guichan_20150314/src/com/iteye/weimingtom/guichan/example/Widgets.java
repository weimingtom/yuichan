...
public class Widgets {
    ...
    private static ScrollArea textBoxScrollArea;
    ...
    private static Image darkbitsImage;
    private static Icon darkbitsIcon;
    private static TabbedArea tabbedArea;
    private static Button tabOneButton;
    private static CheckBox tabTwoCheckBox;

    private static final class DemoListModel extends ListModel {
    ...
    private static DemoListModel demoListModel = new DemoListModel();
