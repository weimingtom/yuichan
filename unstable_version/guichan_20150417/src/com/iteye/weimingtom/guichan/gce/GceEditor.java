...
public class GceEditor implements ApplicationListener {
	...
	public void init() throws GuichanException {
	    ...
	    EditorGui.font = new ImageFont("fonts/font.png", " abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789.,!?-+/():;%&`'*#=[]\"");
	    Widget.setGlobalFont(EditorGui.font);
	    EditorGui.labelFont = new ImageFont("fonts/tiny.png", " abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789.,!?-+/():;%&`'*#=[]\"");
	    initWidgets();
    }
