...
//        delete mFocusHandler;
        ...
        while (!mInput.isKeyQueueEmpty()) {
            ...
            if (mFocusHandler.getFocused() != null) {
                ...
                ApplicationListener appListener = 
            		Globals.app.getApplicationListener();
            	if (appListener != null) {
            		appListener.onKeyPressed(keyEvent);
            	}
    ...
    public void setTop(Widget top) throws GuichanException {
        if (mTop != null) {
    ...
    public void draw() throws GuichanException {
        ...
        ApplicationListener appListener_ = 
        	Globals.app.getApplicationListener();
        if (appListener_ != null) {
        	...
        	appListener_.preDraw(mGraphics);
