...
public class GceTextFieldEdit extends TextField {
	public GceTextFieldEdit() throws GuichanException {
		super();
	}

	public GceTextFieldEdit(String text) throws GuichanException {
		super(text);
	}
